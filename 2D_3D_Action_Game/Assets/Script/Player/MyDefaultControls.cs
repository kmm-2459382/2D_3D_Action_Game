...
//     version 1.14.2
//     from Assets/Script/Player/MyDefaultControls.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Script/Player/MyDefaultControls.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @MyDefaultControls: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ~@MyDefaultControls()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, MyDefaultControls.Player.Disable() has not been called.");
    }
